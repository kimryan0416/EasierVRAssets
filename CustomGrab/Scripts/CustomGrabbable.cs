...
public class CustomGrabbable : MonoBehaviour
{
    ...
    */
    private void Update () {
        ...
        if (m_leftHand != null && m_rightHand != null) {
            ...
            */
            ...
            /*
            Vector3 destination = currentGrabber.grabDestination.position;
            Vector3 frameDestination = destination;
            float distanceToDestination = Vector3.Distance(transform.position, destination);
            isSnapped = distanceToDestination <= 0.01f;
            if (currentGrabber.shouldSnap && !isSnapped) {
    ...
    public void AddGrabber(CustomGrabber cg, Transform to) {
        ...
        posDiff = cg.grabDestination.position - this.transform.position;
        rotDiff = Quaternion.Inverse(cg.grabDestination.localRotation * this.transform.localRotation);
        currentGrabber = cg;
        ...
        switch(cg.OVRController) {
            case(OVRInput.Controller.LTouch):
                ...
                if (m_rightHand == null) {
                    ...
                    r0 = l0;
                    posDiff = m_rightHand.grabDestination.position - this.transform.position;
                    rotDiff = Quaternion.Inverse(m_rightHand.grabDestination.localRotation * this.transform.localRotation);
            ...
            case(OVRInput.Controller.RTouch):
                ...
                if (m_leftHand == null) {
                    ...
                    l0 = r0;
                    leftFirst = true;
                    posDiff = m_leftHand.grabDestination.position - this.transform.position;
                    rotDiff = Quaternion.Inverse(m_leftHand.grabDestination.localRotation * this.transform.localRotation);
