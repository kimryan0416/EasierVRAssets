...
public class EVRA_Grabber : MonoBehaviour
{
    ...
    private EVRA_Grabber m_OtherGrabVolume = null;
    public EVRA_Grabber OtherGrabVolume {
    ...
    */
    ...
    private List<EVRA_GrabTrigger> m_inRange = new List<EVRA_GrabTrigger>();
    public List<EVRA_GrabTrigger> inRange {
        get {   return m_inRange;   }
    }

    [Tooltip("Reference to the object currently being grabbed")] // NOT SERIALIZED
    private EVRA_GrabTrigger m_grabbed = null;
    public EVRA_GrabTrigger grabbed {
    ...
    private void Update() {
        ...
        if (m_grabbed != null) {
            ...
            float alphaVal = (m_inRange.Count > 0 || (m_Pointer != null && m_Pointer.raycastTarget != null && m_Pointer.raycastTarget.GetComponent<EVRA_GrabTrigger>())) ? 1f : 0f;
    ...
    private EVRA_GrabTrigger FindClosestObject() {
        EVRA_GrabTrigger closest = null;
        if (
            m_inRange.Count > 0 && 
            ...
            foreach (EVRA_GrabTrigger obj in m_inRange) {
            ...
            m_Pointer.raycastTarget.GetComponent<EVRA_GrabTrigger>()
        ) {
            closest = m_Pointer.raycastTarget.GetComponent<EVRA_GrabTrigger>();
        }
        return closest;
    }
    ...
    private void OnTriggerEnter(Collider other) {
        ...
        EVRA_GrabTrigger possibleTrigger = other.GetComponent<EVRA_GrabTrigger>();
