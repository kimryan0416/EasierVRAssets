...
public class EVRA_OldGrabTrigger : MonoBehaviour
{
    #region Grabbable Refs
        [Tooltip("To which custom grabbable script am I going to refer to?")] // NO SERIALIZATION
        private EVRA_OldGrabbable m_GrabbableRef;
        public EVRA_OldGrabbable GrabbableRef {
    ...
    public void Init(EVRA_OldGrabbable parent) {
